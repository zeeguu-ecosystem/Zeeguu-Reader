...
exports.default = FeedSubscriber;
;
...
var LanguageMenu = function () {
    ...
    _createClass(LanguageMenu, [{
        ...
        value: function _loadLanguageOptions(data) {
            var options = JSON.parse(data);
            var template = (0, _jquery2.default)(_config2.default.HTML_ID_LANGUAGEOPTION_TEMPLATE).html();
            options.sort();
...
(0, _jquery2.default)(document).ready(function () {
    ...
    if (!addFeedDialog.showModal) _dialogPolyfill2.default.registerDialog(addFeedDialog);
    ...
    showAddFeedDialogButton.addEventListener('click', function () {
        ...
        (0, _jquery2.default)('#' + feedSubscriber.getCurrentLanguage()).focus();
    });
...
/***/ })
/******/ ]);
//# sourceMappingURL=subscription.entry.js.map