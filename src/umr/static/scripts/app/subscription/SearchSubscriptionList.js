...
const SEARCH_SUBSCRIPTION_LOADING_TEXT = "Subscribing to topic: ";
const SEARCH_UNSUBSCRIPTION_LOADING_TEXT = "Unsubscribing from topic: ";
...
export default class SearchSubscriptionList {
    ...
    follow(search_terms) {
        ...
        this._loading(SEARCH_SUBSCRIPTION_LOADING_TEXT + search_terms);
    ...
    _unfollow(search) {
        ...
        this._remove(search);
        this._loading(SEARCH_UNSUBSCRIPTION_LOADING_TEXT + search.search);
