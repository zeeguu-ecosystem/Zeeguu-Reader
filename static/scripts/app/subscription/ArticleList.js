...
export default class ArticleList {
    ...
    load(subscription) {
        ...
        this.zeeguuRequests.get(config.GET_FEED_ITEMS + '/' + subscription['subscriptionID'],
            {}, _.partial(this._loadArticleLinks, subscription));
    };
    ...
    static _loadArticleLinks(subscriptionData, data) {
