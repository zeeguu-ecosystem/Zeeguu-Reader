define(['app/config', 'app/zeeguuRequests', 'underscore'], function (config, zeeguuRequests, _) {
    ...
    return function Translator() {
        ...
        this.translate = function (zeeguuTag) {
            ...
            zeeguuRequests.requestZeeguuPOST(config.GET_TRANSLATIONS_ENDPOINT + '/' + FROM_LANGUAGE + '/' + config.TO_LANGUAGE,
        ...
        function mergeZeeguu(zeeguuTag) {
            ...
            if (node && node.nodeName == config.HTML_ZEEGUUTAG && isTranslated(node)) {
